$(document).ready(function(){
    var data_popup_push_notif = '<div><div class="pa-main-container-wrapper-th-1 pa-th-1-top pa-main-container-th-1 pa-show-subs-box" id="pa-push-notification-subscription" style="display: none;"><div class="pa-subs-box-th pa-subs-box-th-1" style="background-color:#fff!important"><div class="pa-subs-icon-container"><img class="pa-subs-icon" src="https://imggalery.com/uploads/user_61/album_108/1760894940.png" alt="PushAlert" width="64" height="64" style="width:64px;height:64px"></div><div class="pa-subs-msg-box-container"><div class="pa-subs-title-txt-container"><p class="pa-subs-title-txt" style="color:#333!important">Mau Rahasia Jackpot Disini?</p></div><div class="pa-subs-msg-txt-container"><p class="pa-subs-msg-txt" style="color:#777!important">Tekan "YA" untuk Jackpot</p></div></div><div class="pa-subs-btn-container"><div class="pa-subs-btn"><a class="pa-subs-btn-link" id="pa-deny-btn" href="#deny" style="background-color:#d3d3d3!important;color:#888!important">Nanti</a></div><div class="pa-subs-btn"><a class="pa-subs-btn-link" id="pa-allow-btn" href="#allow" style="background-color:#0e82e5!important;color:#fff!important">Ya</a></div></div></div></div></div>';
