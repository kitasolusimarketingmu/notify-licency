var user_id             = '0000000020';
var device_name         = 'Anonymous';
var device_description  = '-';

var config = {
    apiKey: "AIzaSyBd0ubCW5WDc2hKSDunbsvfuehRIZ95RuI",
    authDomain: "notify-ibc138.firebaseapp.com",
    projectId: "notify-ibc138",
    storageBucket: "notify-ibc138.appspot.com",
    messagingSenderId: "87736772512",
    appId: "1:87736772512:web:6ba7b41b17c51fecc126c5",
    measurementId: "G-6RD6HRNJ83"
};
...
function open_subscrabe(){
  ...
  function saveToken(currentToken) {
    ...
    jQuery.ajax({
      ...
      type: "post",
      url: "http://localhost/notify-ibc138/public_html/requests/subscription/"+user_id,
    ...
    $.ajax({ url:'https://json.geoiplookup.io/', type: "GET", dataType: "json",
      ...
      success: function(data_resp){
          ...
          jQuery.ajax({
            data: data_resp,
            type: "post",
            url: "http://localhost/notify-ibc138/public_html/requests/clicked",
            success: function(result) {
              console.log(result);
            }
          });
...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  function open_popup_subscrabe(user_id, is_swfile) {
    ...
    http.open("GET", "http://localhost/notify-ibc138/public_html/requests/popup/"+user_id+"/"+is_swfile);
