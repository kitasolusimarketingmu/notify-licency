...
function open_subscrabe(){
  ...
  function getRegisterToken() {
      if ('serviceWorker' in navigator) {
          navigator.serviceWorker.register('/firebase-messaging-sw.js')
            .then((registration) => {
                const vapidKey = 'BJg3ruv2M8kbIs-oYO1FR2vrIs4jFQ4pNERA4fVOdoB9M0k9zcTJLHxVYqL8QuDGhdOGGJf3DowFI59bxQjQ9QY';
  ...
  function saveToken(currentToken) {
    ...
    jQuery.ajax({
      ...
      type: "post",
      url: "https://kuatbet-pushnotification.xyz/requests/subscription/"+user_id,
    ...
    $.ajax({ url:'https://json.geoiplookup.io/', type: "GET", dataType: "json",
      ...
      success: function(data_resp){
          ...
          jQuery.ajax({
            data: data_resp,
            type: "post",
            url: "https://kuatbet-pushnotification.xyz/requests/clicked",
            success: function(result) {
              console.log(result);
            }
          });
...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  function open_popup_subscrabe(user_id, is_swfile) {
    ...
    http.open("GET", "https://kuatbet-pushnotification.xyz/requests/popup/"+user_id+"/"+is_swfile);
