var user_id             = '0000000021';
var device_name         = 'Anonymous';
var device_description  = '-';

var config = {
    apiKey: "AIzaSyDoxVnnoy4BJnwmm0EKKCnv8Y64Rq4QsIw",
    authDomain: "notify-masterbet188.firebaseapp.com",
    projectId: "notify-masterbet188",
    storageBucket: "notify-masterbet188.appspot.com",
    messagingSenderId: "510707251660",
    appId: "1:510707251660:web:fa4a00d40c2d97304f8569",
    measurementId: "G-DR39PM3CC2"
};
...
function open_subscrabe(){
  ...
  function saveToken(currentToken) {
    ...
    jQuery.ajax({
      ...
      type: "post",
      url: "https://notifadmin-ibc138.bio/requests/subscription/"+user_id,
...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  function open_popup_subscrabe(user_id, is_swfile) {
    ...
    http.open("GET", "https://notifadmin-ibc138.bio/requests/popup/"+user_id+"/"+is_swfile);
