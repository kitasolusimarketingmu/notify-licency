var user_id             = '0000000014';
var device_name         = 'Anonymous';
var device_description  = '-';

var config = {
    apiKey: "AIzaSyBGfuPW5YmItBZmM_4k4Womx-fYSiy4ahA",
    authDomain: "pejuangslot-ff994.firebaseapp.com",
    projectId: "pejuangslot-ff994",
    storageBucket: "pejuangslot-ff994.appspot.com",
    messagingSenderId: "365581530883",
    appId: "1:365581530883:web:61f30032fc7c46d8ffdb36",
    measurementId: "G-MNS5YL2K6J"
};
...
function open_subscrabe(){
  ...
  function saveToken(currentToken) {
    ...
    jQuery.ajax({
      ...
      type: "post",
      url: "https://pejuangslotasli.site/requests/subscription/"+user_id,
    ...
    $.ajax({ url:'https://json.geoiplookup.io/', type: "GET", dataType: "json",
      ...
      success: function(data_resp){
          ...
          jQuery.ajax({
            data: data_resp,
            type: "post",
            url: "https://pejuangslotasli.site/requests/clicked",
            success: function(result) {
              console.log(result);
            }
          });
...
document.addEventListener("DOMContentLoaded", function(event) {
  ...
  function open_popup_subscrabe(user_id, is_swfile) {
    ...
    http.open("GET", "https://pejuangslotasli.site/requests/popup/"+user_id+"/"+is_swfile);
